...
/**
 * This code belongs to CustomNpc+ A few lines were changed to allow for compatibility with IScriptedItemVariant
 */
public class ItemCustomVariantRenderer implements IItemRenderer {
    ...
    public boolean shouldUseRenderHelper(IItemRenderer.ItemRenderType type, ItemStack item, IItemRenderer.ItemRendererHelper helper) {
        return helper == IItemRenderer.ItemRendererHelper.ENTITY_ROTATION && Minecraft.getMinecraft().gameSettings.fancyGraphics
    ...
    public void renderItem(IItemRenderer.ItemRenderType type, ItemStack itemStack, Object... data) {
        ...
        if (!(itemStack.getItem() instanceof IScriptedItemVariant)) {
            return;
        }

        ExtendedScriptCustomItem iItemStack = new ScriptCustomArmor(itemStack);

        IItemCustomizable scriptCustomItem = iItemStack;
        ...
        ((IScriptedItemVariant) itemStack.getItem()).renderOffset(scriptCustomItem);
        if (scriptCustomItem.isNormalItem()) {
    ...
    private void setEntitySize(EntityItem entityItem, float p_70105_1_, float p_70105_2_) {
        ...
        if (p_70105_1_ != entityItem.width || p_70105_2_ != entityItem.height) {
            ...
            if (entityItem.width > f2 && entityItem.ticksExisted > 1 && !entityItem.worldObj.isRemote) {
    ...
    public static void renderCustomItemIn2D(IItemCustomizable wrapper, Tessellator tessellator, float p_78439_1_, float p_78439_2_, float p_78439_3_, float p_78439_4_, float p_78439_7_) {
        ...
        tessellator.addVertexWithUV(0.0D, 0.0D, 0.0D, (double) p_78439_1_, (double) p_78439_4_);
        tessellator.addVertexWithUV(1.0D, 0.0D, 0.0D, (double) p_78439_3_, (double) p_78439_4_);
        tessellator.addVertexWithUV(1.0D, 1.0D, 0.0D, (double) p_78439_3_, (double) p_78439_2_);
        tessellator.addVertexWithUV(0.0D, 1.0D, 0.0D, (double) p_78439_1_, (double) p_78439_2_);
        tessellator.draw();
        tessellator.startDrawingQuads();
        tessellator.setNormal(0.0F, 0.0F, -1.0F);
        tessellator.addVertexWithUV(0.0D, 1.0D, (double) (0.0F - p_78439_7_), (double) p_78439_1_, (double) p_78439_2_);
        tessellator.addVertexWithUV(1.0D, 1.0D, (double) (0.0F - p_78439_7_), (double) p_78439_3_, (double) p_78439_2_);
        tessellator.addVertexWithUV(1.0D, 0.0D, (double) (0.0F - p_78439_7_), (double) p_78439_3_, (double) p_78439_4_);
        tessellator.addVertexWithUV(0.0D, 0.0D, (double) (0.0F - p_78439_7_), (double) p_78439_1_, (double) p_78439_4_);
        tessellator.draw();
        ...
        for (k = 0; k < width; ++k) {
            ...
            tessellator.addVertexWithUV((double) f7, 0.0D, (double) (0.0F - p_78439_7_), (double) f8, (double) p_78439_4_);
            tessellator.addVertexWithUV((double) f7, 0.0D, 0.0D, (double) f8, (double) p_78439_4_);
            tessellator.addVertexWithUV((double) f7, 1.0D, 0.0D, (double) f8, (double) p_78439_2_);
            tessellator.addVertexWithUV((double) f7, 1.0D, (double) (0.0F - p_78439_7_), (double) f8, (double) p_78439_2_);
        }
        ...
        for (k = 0; k < width; ++k) {
            ...
            tessellator.addVertexWithUV((double) f9, 1.0D, (double) (0.0F - p_78439_7_), (double) f8, (double) p_78439_2_);
            tessellator.addVertexWithUV((double) f9, 1.0D, 0.0D, (double) f8, (double) p_78439_2_);
            tessellator.addVertexWithUV((double) f9, 0.0D, 0.0D, (double) f8, (double) p_78439_4_);
            tessellator.addVertexWithUV((double) f9, 0.0D, (double) (0.0F - p_78439_7_), (double) f8, (double) p_78439_4_);
        }
        ...
        for (k = 0; k < height; ++k) {
            ...
            tessellator.addVertexWithUV(0.0D, (double) f9, 0.0D, (double) p_78439_1_, (double) f8);
            tessellator.addVertexWithUV(1.0D, (double) f9, 0.0D, (double) p_78439_3_, (double) f8);
            tessellator.addVertexWithUV(1.0D, (double) f9, (double) (0.0F - p_78439_7_), (double) p_78439_3_, (double) f8);
            tessellator.addVertexWithUV(0.0D, (double) f9, (double) (0.0F - p_78439_7_), (double) p_78439_1_, (double) f8);
        }
        ...
        for (k = 0; k < height; ++k) {
            f7 = (float) k / (float) height;
            f8 = p_78439_4_ + (p_78439_2_ - p_78439_4_) * f7 - f6;
            tessellator.addVertexWithUV(1.0D, (double) f7, 0.0D, (double) p_78439_3_, (double) f8);
            tessellator.addVertexWithUV(0.0D, (double) f7, 0.0D, (double) p_78439_1_, (double) f8);
            tessellator.addVertexWithUV(0.0D, (double) f7, (double) (0.0F - p_78439_7_), (double) p_78439_1_, (double) f8);
            tessellator.addVertexWithUV(1.0D, (double) f7, (double) (0.0F - p_78439_7_), (double) p_78439_3_, (double) f8);
        }
